      ...
      const generateExercises = (type: string, intensity: string): Exercise[] => {
        ...
        if (isGymTraining) {
          ...
          switch (type) {
            ...
            case 'Core e Cardio':
              exercises.push(
                { name: 'Abdominal Bicicleta', sets: baseSets, reps: '30s', rest: baseRest, notes: ['Movimento controlado'] },
                { name: 'Mountain Climbers', sets: baseSets, reps: '30s', rest: baseRest, notes: ['Ritmo constante'] },
                { name: 'Prancha Lateral', sets: baseSets, reps: '30s por lado', rest: baseRest, notes: ['Core estável'] },
                { name: 'Burpees', sets: baseSets, reps: '10-12', rest: baseRest, notes: ['Explosão'] },
                { name: 'Russian Twist', sets: baseSets, reps: '20 cada lado', rest: baseRest, notes: ['Rotação controlada'] },
                { name: 'Jumping Jacks', sets: baseSets, reps: '30s', rest: baseRest, notes: ['Ritmo constante'] },
                { name: 'Dead Bug', sets: baseSets, reps: '12 cada lado', rest: baseRest, notes: ['Core ativado'] },
                { name: 'High Knees', sets: baseSets, reps: '30s', rest: baseRest, notes: ['Joelhos altos'] },
                { name: 'Prancha com Toque no Ombro', sets: baseSets, reps: '20 total', rest: baseRest, notes: ['Estabilidade'] },
                { name: 'Pulo de Corda', sets: baseSets, reps: '1 min', rest: baseRest, notes: ['Ritmo constante'] }
              );
              break;
